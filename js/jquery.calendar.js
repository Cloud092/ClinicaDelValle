	...
	({
		...
		FullCalendarExt: function(options)
		{
            ...
            var defaults =
			{
				...
				successAddEventMessage: 'Cita agregada con exito',
				successDeleteEventMessage: 'Cita eliminada con exito',
				successUpdateEventMessage: 'Cita actualizada con exito',
				...
				eventText: 'Evento: ',
				repetitiveEventActionText: 'Este es un evento repetitivo, que desea hacer?',

				isRTL: false,
				monthNames: ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'],
				monthNamesShort: ['Ene','Feb','Mar','Abr','May','Jun','Jul','Ago','Sep','Oct','Nov','Dic'],
				dayNames: ['Domingo','Luner','Martes','Miercoles','Jueves','Viernes','Sabado'],
									...
									if(calendar.url === 'undefined')
									{
										$(".modal-header").html(
											'<form id="event_title_e">' +
												...
												'<input type="text" class="input-block-level" name="title_update" value="'+calendar.title+'">' +
											'</form>'
										);
										$(".modal-body").html(
											'<form id="event_description_e">' +
												'<label>'+opt.descriptionText+' </label>' +
												'<textarea class="input-block-level" name="description_update">'+description2+'</textarea>' +
										...
										$(".modal-body").html(
											'<form id="event_description_e">' +
												...
												'</div>' +
												'<div class="clearfix"></div>' +
												'<label>URL: </label>'+'<input type="text" class="input-block-level" name="url_update" value="'+calendar.url+'">' +
											'</form>'
											);
									}
				...
				calendar.quickModal = function(start, end, allDay)
				{
					...
					$(".modal-body").html(
						'<form id="event_description">' +
							'<label>'+opt.descriptionText+' </label>' +
						    '<textarea class="input-block-level" name="description"></textarea>' + opt.quickSaveCategory +
						 '</form>'
						 );
