  ...
  <body>
    ...
    <div class="span8">
        <div class="table-bordered" style="border: 1px solid #ddd; padding: 10px;">
             ...
             <a href="index.php" class="pull-right" style="margin-bottom: 20px;">Volver</a>
            ...
            <a href="#" class="pull-right" onclick="calendar.remove(<?php echo $info['id']; ?>)">Eliminar esta cita</a>
    		<a href="edit_event.php?page=<?php echo $_GET['page']; ?>" class="pull-right mr-10">Editar esta cita</a>
